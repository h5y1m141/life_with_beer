...
articles = [
  {
    title: "2016年要注目の新宿南口エリアで美味しいビールが飲めるお店",
    publish_status: 1
  }
  # {
...
article_elements = [
  ...
  # },
  {
    article_id: 1,
    tag_name: "description",
    element_data: "商業施設の「NEWoMan」（ニュウマン）の開業で南口エリアはだいぶ整備されてアクセスしやすくなったように思います。\n\nそして気づいたら南口エリアで美味しいビールが飲めるお店が増えた気がするのでいくつかお店をピックアップしてみました",
    sory_key: 1
  },
  {
    article_id: 1,
    tag_name: "sub_head",
    element_data: "まずは最近オープンしたてのGARDEN HOUSE Shinjuku",
    sory_key: 2
  },
  {
    article_id: 1,
    tag_name: "description",
    element_data: "鎌倉で人気のレストランGARDEN HOUSE（ガーデンハウス）。その東京第1号店が新宿のNEWoManにオープンしました。",
    sory_key: 3
  },
  {
    article_id: 1,
    tag_name: "description",
    element_data: "調べた所によると、鎌倉ビールさんとのコラボによるGARDEN HOUSE PALE ALEなどのオリジナルのクラフトビールを提供してるみたいです",
    sory_key: 4
  },
  {
    article_id: 1,
